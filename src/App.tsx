  ...
  return (
    <div className="min-h-screen bg-[var(--dark)] text-[var(--light)]">
      ...
      <div className="splash-text-container text-center my-8">
        <h2 className="splash-text text-[var(--primary)] text-4xl font-bold animate-pulse">
          BON PLAN
        </h2>
      </div>
      ...
      <button
        ...
        className="fixed bottom-5 right-5 w-12 h-12 rounded-full bg-[var(--primary)] text-[var(--dark)] flex items-center justify-center cursor-pointer shadow-lg z-[1000] transition-all duration-300 hover:scale-110 animate-pulse"
